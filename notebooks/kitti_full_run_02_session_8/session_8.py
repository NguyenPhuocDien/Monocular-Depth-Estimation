"""
BTS KITTI Full Run 02 — Session 8 (FINAL 50 EPOCHS MILESTONE)
Resume: Step 235,000 → 289,500  (~40.6 → 50.0 Full Epochs)
Hardware: 2x Tesla T4  |  DDP DistributedDataParallel
Duration: ~9.0 hours (Final Overdraft GPU Session)
"""
...
class CFG:
    ...
    # Step boundaries
    resume_step       = 235_000   # last committed step from Session 7
    first_step        = 235_001   # first new optimizer step this session
    target_step       = 289_500   # 54,500 steps (FULL 50 EPOCHS COMPLETION)
    ...
    sha = {
        ...
        "initial_ckpt":     "cae7c8ab9f6ca923909c39589d20077b192d80728dfd37534effa066fc5ca136",
...
SESSION_CFG   = WORK / "session_8_config.txt"
HANDOFF       = WORK / "session_8_handoff"
LOG_FILE      = WORK / "session_8_training.log"
STARTUP_FILE  = WORK / "session_8_startup_audit.json"
START_FILE    = WORK / "session_8_start_receipt.json"
BOUNDARY_FILE = WORK / "session_8_boundary_receipt.json"
...
def startup_audit() -> dict:
    ...
    th_home = Path("/tmp/bts_s8_torch_home")

"""
BTS KITTI Full Run 02 — Session 5
Resume: Step 105,000 → 145,000  (~18.1 → 25.0 Epochs)
...
class CFG:
    ...
    # Step boundaries
    resume_step       = 105_000   # last committed step from Session 4
    first_step        = 105_001   # first new optimizer step this session
    target_step       = 145_000   # stop-signal boundary
    ...
    sha = {
        ...
        "initial_ckpt":     "27fcbb3265fde23d603fb8bd0e78884e3fa8dc9980fa5179561191bc00049ac6",
...
SESSION_CFG   = WORK / "session_5_config.txt"
HANDOFF       = WORK / "session_5_handoff"
LOG_FILE      = WORK / "session_5_training.log"
STARTUP_FILE  = WORK / "session_5_startup_audit.json"
START_FILE    = WORK / "session_5_start_receipt.json"
BOUNDARY_FILE = WORK / "session_5_boundary_receipt.json"
...
def startup_audit() -> dict:
    ...
    # bts_main.py line 139-143: when --checkpoint_path is set, it does:
    #   model_dir = os.path.dirname(checkpoint_path)  => /kaggle/working/resume_source
    #   model_name = os.path.basename(model_dir)      => "resume_source"
    #   sys.path.append(model_dir)
    #   __import__(model_name)                         => needs resume_source.py here
    ...
    th_home = Path("/tmp/bts_s5_torch_home")

"""
BTS KITTI Full Run 02 — Session 7
Resume: Step 190,000 → 235,000  (~32.8 → 40.6 Epochs)
Hardware: 2x Tesla T4  |  DDP DistributedDataParallel
Duration: ~7.4 hours (Ultra-Safe Quota Buffer Strategy)
"""
...
class CFG:
    ...
    # Step boundaries
    resume_step       = 190_000   # last committed step from Session 6
    first_step        = 190_001   # first new optimizer step this session
    target_step       = 235_000   # 45,000 steps (~7.4h running, leaves ~7h buffer for S8)
    ...
    sha = {
        ...
        "initial_ckpt":     "f26f20d2b2bf19a4772ab077b1a78aecd57bdfc1310d67acba19fadda57b3f7f",
...
SESSION_CFG   = WORK / "session_7_config.txt"
HANDOFF       = WORK / "session_7_handoff"
LOG_FILE      = WORK / "session_7_training.log"
STARTUP_FILE  = WORK / "session_7_startup_audit.json"
START_FILE    = WORK / "session_7_start_receipt.json"
BOUNDARY_FILE = WORK / "session_7_boundary_receipt.json"
...
def startup_audit() -> dict:
    ...
    th_home = Path("/tmp/bts_s7_torch_home")
